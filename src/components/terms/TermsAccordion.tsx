        ...
        return (
          ...
          >
            <button
              ...
              className="flex w-full items-center justify-between gap-3 px-4 py-3 text-left text-white focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-inset md:px-5 md:py-3.5"
